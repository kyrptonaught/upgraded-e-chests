...
public class SpatialEChest extends EnderChestBlock {
    ...
    public SpatialEChest(Settings settings) {
        super(settings);
        Registry.register(Registries.BLOCK, new Identifier(UpgradedEchestMod.MOD_ID, "spatialchest"), this);
        blockEntity = Registry.register(Registries.BLOCK_ENTITY_TYPE, UpgradedEchestMod.MOD_ID + ":spatialchest", FabricBlockEntityTypeBuilder.create(SpatialEChestBlockEntity::new, this).build(null));
        Registry.register(Registries.ITEM, new Identifier(UpgradedEchestMod.MOD_ID, "spatialchest"), new BlockItem(this, new Item.Settings()));
